...
public class BlockHighSpeedRepeater extends BlockExtension implements DirectionHelper
{
    ...
    public void neighborUpdate2(BlockState state, World world, BlockPos pos, Block block, BlockPos fromPos, boolean notify) {
        ...
        final boolean powered = world.getBlockState(blockPos1).getDirectSignal(new BlockView(world.data), blockPos1, direction) > 0;
    ...
    protected int getInputLevel(World world, BlockPos pos, Direction dir) {
        ...
        return world.getBlockState(pos).getDirectSignal(new BlockView(world.data), pos, dir);
    }
    ...
    protected void updateTarget(World world, BlockPos pos, BlockState state) {
        ...
        world.updateNeighborsAt(blockPos, this.asBlock2());
        world.updateNeighborsAtExceptFromFacing(blockPos, this.asBlock2(), direction, null);
    }
    ...
    public BlockState getPlacementState2(ItemPlacementContext ctx) {
        ...
        final boolean powered = ctx.getWorld().getBlockState(blockPos).getDirectSignal(new BlockView(ctx.getWorld().data), blockPos, direction) > 0;
