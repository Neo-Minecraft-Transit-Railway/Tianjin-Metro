...
public class BlockPlayerDetector extends BlockExtension implements DirectionHelper, BlockWithEntity
{
    ...
    public BlockPlayerDetector() {
        this(Blocks.createDefaultBlockSettings(false).instabreak());
    }
    ...
    public static class BlockEntity extends BlockEntityExtension
    {
        ...
        public void blockEntityTick() {
            ...
            final PlayerEntity player = this.getWorld2().getNearestPlayer(this.getPos2().getX(), this.getPos2().getY(), this.getPos2().getZ(), IntegerGameRule.getValue(ServerWorld.cast(this.getWorld2()), GameRules.PLAYER_DETECT_RANGE), false);
