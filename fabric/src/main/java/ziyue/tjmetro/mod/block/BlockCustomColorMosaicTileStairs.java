...
public class BlockCustomColorMosaicTileStairs extends StairBlock implements BlockWithEntity
{
    public BlockCustomColorMosaicTileStairs() {
    ...
    public static class BlockEntity extends BlockCustomColorBase.BlockEntityBase
    {
        public BlockEntity(BlockPos blockPos, BlockState blockState) {
            super(BlockEntityTypes.CUSTOM_COLOR_MOSAIC_TILE_STAIRS.get(), blockPos, blockState);
        }
    }
}
