...
public class BlockCustomColorMosaicTileSlab extends SlabBlockExtension implements BlockWithEntity
{
    public BlockCustomColorMosaicTileSlab() {
        this(Blocks.createDefaultBlockSettings(false));
    }

    public BlockCustomColorMosaicTileSlab(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public static class BlockEntity extends BlockCustomColorBase.BlockEntityBase
    {
        public BlockEntity(BlockPos blockPos, BlockState blockState) {
            super(BlockEntityTypes.CUSTOM_COLOR_MOSAIC_TILE_SLAB.get(), blockPos, blockState);
        }
    }
}
