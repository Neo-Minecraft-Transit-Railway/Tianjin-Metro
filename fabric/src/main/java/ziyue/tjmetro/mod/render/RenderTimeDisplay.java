    ...
    public void render(T entity, float tickDelta, GraphicsHolder graphicsHolder, int light, int overlay) {
        ...
        if (entity instanceof BlockTimeDisplayEven.BlockEntity) {
            ...
            MainRenderer.scheduleRender(QueuedRenderLayer.TEXT, (newGraphicsHolder, offset) -> {
                ...
                IDrawingExtension.drawStringWithFont(newGraphicsHolder, getFormattedTime(entity.getWorld2().getDayTime()), HorizontalAlignment.CENTER, VerticalAlignment.CENTER, HorizontalAlignment.CENTER, 0, 0.03F, -1, -1, 30, -3276781, -3276781, 2, false, light, true, null);
